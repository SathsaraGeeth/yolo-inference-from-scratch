...
1. Model extraction  
model_extract.ipynb – Extracts model parameters, weights, and structure into a canonical format. Running this notebook generates the output in the model/ directory.
